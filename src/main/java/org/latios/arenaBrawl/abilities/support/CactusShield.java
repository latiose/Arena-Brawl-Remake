...
public class CactusShield implements Ability {
    ...
    public CactusShield(CooldownManager cooldownManager, OrbitShieldManager orbitShieldManager,
                        CombatUpgradeManager combatUpgradeManager, AbilityConfig config) {
        this.cooldownMs = config.getLong("cooldown-ms", 30000L);
        this.cost = new CooldownCost(cooldownManager, "cactusshield", cooldownMs, combatUpgradeManager);
